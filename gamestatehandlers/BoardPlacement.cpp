...
enum GameState handleBoardPlacement(enum Event event) {
    if(event == BUTTON0_PRESS || event == BUTTON0_UNPRESS || event == BUTTON1_PRESS || event == BUTTON1_UNPRESS || event == BUTTON2_PRESS || event == BUTTON2_UNPRESS || event == BUTTON3_PRESS || event == BUTTON3UNPRESS)
    {
        return;
    }
